...
def calculate_dog_years():
    ...
    Year= int(input("Enter a dog's age: "))
...
def weather_advice():
    ...
    cold = input('Please enter if it is cold (yes/no): ').lower()
    raining = input('Please enter if it is raining (yes/no): ').lower()
    ...
    if cold == "yes" and raining == "yes":
        ...
        print("You have to write yes/no.")
...
def determine_season():
    ...
    if month not in months:
        print("Invalid month! Please enter a valid 3-letter month abbreviation (e.g., Jan, Feb, Mar, ...)")
        return

    day_input = input("Enter the day of the month: ")
    if not day_input.isdigit():
        print("Invalid day! Please enter a valid number (e.g., 5, 12, 31, ...)")
        return
    day = int(day_input)
    if day < 1 or day > 31:
    ...
    if (month == 'Dec' and day >= 21) or (month == 'Jan') or (month == 'Feb') or (month == 'Mar' and day <= 19):
        ...
        print("Invalid date! Please check your inputs.")
        return
...
def guess_number():
    ...
    for attempt in range(1, 6):
        ...
        user_input = input(f"Attempt {attempt}: Guess a number between {lowest_num} and {highest_num}: ")
        ...
        if guess < lowest_num or guess > highest_num:
            print(f"The number is out of the range. Please guess a number between {lowest_num} and {highest_num}.")
            continue
        ...
        elif guess > target_number and guess <= highest_num:
